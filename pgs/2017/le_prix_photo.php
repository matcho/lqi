<!-- prix photo 2017 -->
<!-- @TODO_AURELIEN saisir ici les données 2017, remplacer tous les noms partout (chiant !) -->
	...
	<section class="prix_photos diaporama content" data-nom="dondyuk" <?php echo $nom != 'dondyuk' ? 'style="display:none;"' : '' ?>>
		<div id="content">
			<div class="conteneur-diaporama">
				...
				<div class="commandes">
					<a class="lien-plein-ecran" href="diaporama.php?&auteur=maxim_dondyuk&retour=le_prix_photo.php?annee=2017|nom=dondyuk">
	...
	<section class="prix_photos diaporama content" data-nom="geldhof" <?php echo $nom != 'geldhof' ? 'style="display:none;"' : '' ?>>
		<div id="content">
			<div class="conteneur-diaporama">
				...
				<div class="commandes">
					<a class="lien-plein-ecran" href="diaporama.php?&auteur=mathilde_geldhof&retour=le_prix_photo.php?annee=2017|nom=geldhof">
						<img class="plein-ecran" src="../img/plein-ecran.png" />
					</a>
					<span class="decompte"><span class="numero-photo">1</span> / <span class="total-photos"></span></span>
					<div class="fleches">
	...
	<section class="prix_photos diaporama content" data-nom="goldgruber" <?php echo $nom != 'goldgruber' ? 'style="display:none;"' : '' ?>>
		<div id="content">
			<div class="conteneur-diaporama">
				...
				<div class="commandes">
					<a class="lien-plein-ecran" href="diaporama.php?&auteur=michael_goldgruber&retour=le_prix_photo.php?annee=2017|nom=goldgruber">
						<img class="plein-ecran" src="../img/plein-ecran.png" />
					</a>
					<span class="decompte"><span class="numero-photo">1</span> / <span class="total-photos"></span></span>
					<div class="fleches">
	...
	<section class="prix_photos diaporama content" data-nom="hyland" <?php echo $nom != 'hyland' ? 'style="display:none;"' : '' ?>>
		<div id="content">
			<div class="conteneur-diaporama">
				...
				<div class="commandes">
					<a class="lien-plein-ecran" href="diaporama.php?&auteur=gillian_hyland&retour=le_prix_photo.php?annee=2017|nom=hyland">
						<img class="plein-ecran" src="../img/plein-ecran.png" />
					</a>
					<span class="decompte"><span class="numero-photo">1</span> / <span class="total-photos"></span></span>
					<div class="fleches">
